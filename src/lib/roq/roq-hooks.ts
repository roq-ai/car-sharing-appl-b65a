...
export function useVarebilFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVarebilFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.varebil.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVarebilCount<T extends Prisma.varebilCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.varebilCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useVarebilCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.varebil.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVarebilFindManyWithCount<
  T extends Prisma.varebilFindManyArgs,
  R extends { data: GetFindResult<Prisma.$varebilPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.varebilFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVarebilFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.varebil.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVarebilFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVarebilFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.varebil.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVehicleTypeFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVehicleTypeFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.vehicle_type.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVehicleTypeCount<T extends Prisma.vehicle_typeCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.vehicle_typeCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useVehicleTypeCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.vehicle_type.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVehicleTypeFindManyWithCount<
  T extends Prisma.vehicle_typeFindManyArgs,
  R extends { data: GetFindResult<Prisma.$vehicle_typePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.vehicle_typeFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVehicleTypeFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.vehicle_type.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useVehicleTypeFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useVehicleTypeFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.vehicle_type.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
